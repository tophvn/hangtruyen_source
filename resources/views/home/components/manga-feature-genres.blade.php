                ...
                <div class="g-item splide__slide">
                    <div class="genre-content">
                        <a href="/genre/action" class="g-link" aria-label="Action">
                            ...
                            <div class="g-thumb">
                                <img src="{{ asset('images/home/tag-img/action.png') }}" alt="Action" />
                                <div class="num-series"><strong>6028</strong>bộ truyện</div>
                            </div>
                ...
                <div class="g-item splide__slide">
                    <div class="genre-content">
                        <a href="/genre/romance" class="g-link" aria-label="Romance">
                            ...
                            <div class="g-thumb">
                                <img src="{{ asset('images/home/tag-img/romance.png') }}" alt="Romance" />
                                <div class="num-series"><strong>5931</strong>bộ truyện</div>
                            </div>
                            <svg xmlns="http://www.w3.org/2000/svg" width="325" height="234" viewBox="0 0 325 234" fill="none" class="bg-cat">
                ...
                <div class="g-item splide__slide">
                    <div class="genre-content">
                        <a href="/genre/comedy" class="g-link" aria-label="Comedy">
                            ...
                            <div class="g-thumb">
                                <img src="{{ asset('images/home/tag-img/comedy.png') }}" alt="Comedy" />
                                <div class="num-series"><strong>5548</strong>bộ truyện</div>
                            </div>
                            <svg xmlns="http://www.w3.org/2000/svg" width="325" height="234" viewBox="0 0 325 234" fill="none" class="bg-cat">
                ...
                <div class="g-item splide__slide">
                    <div class="genre-content">
                        <a href="/genre/fantasy" class="g-link" aria-label="Fantasy">
                            ...
                            <div class="g-thumb">
                                <img src="{{ asset('images/home/tag-img/fantasy.png') }}" alt="Fantasy" />
                                <div class="num-series"><strong>3983</strong>bộ truyện</div>
                            </div>
                            <svg xmlns="http://www.w3.org/2000/svg" width="325" height="234" viewBox="0 0 325 234" fill="none" class="bg-cat">
