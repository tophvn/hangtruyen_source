...
@section('title', $siteName . ' - Đọc Truyện Tranh Online Manga, Manhua, Manhwa Miễn Phí | Cập Nhật Mới Nhất')
@section('description', $siteName . ' - Website đọc truyện tranh online miễn phí hàng đầu Việt Nam. Cập nhật truyện manga, manhua, manhwa mới nhất mỗi ngày. Đọc truyện full, không quảng cáo, chất lượng cao. Hàng nghìn truyện tranh hot trending đang chờ bạn khám phá.')
...
@section('og:title', $siteName . ' - Đọc Truyện Tranh Online Manga, Manhua, Manhwa Miễn Phí')
@section('og:description', $siteName . ' - Website đọc truyện tranh online miễn phí hàng đầu Việt Nam. Cập nhật truyện manga, manhua, manhwa mới nhất mỗi ngày.')
...
<script type="application/ld+json">
{
    ...
    "description": "Tổng hợp các truyện tranh manga, manhua, manhwa mới cập nhật nhất tại {{ $siteName }}",
    "url": "{{ url('/') }}"
}
</script>
@endpush
...
@section('content')
    ...
    <div class="container content-seo">
        <div class="page-content short-content">
            <hr>
            <span style="font-weight: 400">Cùng khám phá {{ $siteName }} nền tảng đọc truyện tranh online miễn phí,
                kho truyện đa dạng, giao diện dễ dùng.</span>
            <h2><b>{{ $siteName }} Web Đọc Truyện Hot Nhất Hiện Nay</b></h2>
            <span style="font-weight: 400">Giữa muôn vàn nền tảng đọc truyện hiện nay,
                <a href="{{ url('/') }}">{{ $siteName }}</a> nổi lên như một cái tên
            ...
            <span style="font-weight: 400">Là một trong những nền tảng đọc
                ...
                chỉ đơn thuần là một trang web đọc truyện, {{ $siteName }} còn là nơi gắn
            ...
            <span style="font-weight: 400">{{ $siteName }} bắt đầu xuất hiện từ những năm đầu của thập kỷ 2010,
            ...
            <span style="font-weight: 400">Ban đầu, trang web chỉ tập trung vào những bộ manga nổi tiếng từ
                ...
                là {{ $siteName }} không chỉ đơn thuần sao chép nội dung, mà còn đầu tư
            ...
            <span style="font-weight: 400">Điều làm nên bản sắc riêng của {{ $siteName }} không chỉ nằm ở số lượng
            ...
            <span style="font-weight: 400">-</span><b> Giao diện thân thiện, dễ sử dụng:</b><span style="font-weight: 400">
                Không rối mắt, không quảng cáo chen ngang quá mức, {{ $siteName }} tập
            ...
            <b>- Sự gắn bó vô hình:</b><span style="font-weight: 400">
                Với nhiều người, {{ $siteName }} không đơn thuần là một trang web, mà là
            ...
            <span style="font-weight: 400">Trong một thế giới số hóa đầy biến động, nơi mà thói quen giải trí
                thay đổi liên tục, {{ $siteName }} vẫn giữ được bản sắc và vị trí riêng
                ...
                người.</span>
            <h2><b>Những Tính Năng Nổi Bật Của {{ $siteName }}</b></h2>
            <span style="font-weight: 400">Đây không chỉ đơn thuần là một trang web đọc truyện tranh, mà còn
                ...
                năng nổi bật khiến {{ $siteName }} trở thành lựa chọn hàng đầu của hàng
                triệu độc giả.</span>
            ...
            <span style="font-weight: 400">Không chỉ đa dạng, {{ $siteName }} còn nổi bật bởi tốc độ cập nhật cực
            ...
            <span style="font-weight: 400">Ngay từ lần đầu truy cập, trang tạo được ấn tượng bởi giao diện gọn
                ...
                ngợp bởi quảng cáo dày đặc như nhiều nền tảng khác, {{ $siteName }} tập
            ...
            <span style="font-weight: 400">Với hàng ngàn bộ truyện được cập nhật liên tục, {{ $siteName }} đã phát
            ...
            <span style="font-weight: 400">{{ $siteName }} không chỉ là nơi đọc truyện mà còn là không gian giao lưu
            ...
            <h2><b>So Sánh {{ $siteName }} Với Các Nền Tảng Khác</b></h2>
            <span style="font-weight: 400">Trong bối cảnh thị trường truyện tranh trực tuyến ngày càng sôi
                ...
                ấy, {{ $siteName }} vẫn giữ vững vị thế là một trong những nền tảng đọc
            ...
            <span style="font-weight: 400">So với các nền tảng khác như TruyenQQ, VlogTruyen hay Pops,
                {{ $siteName }} sở hữu một loạt ưu điểm khiến người đọc gắn bó lâu
                dài:</span>
            ...
            <b>- Cộng đồng tương tác sôi nổi:</b><span style="font-weight: 400">
                ...
                kết điểm đặc biệt khiến trải nghiệm đọc trên website trở nên sinh
            ...
            <span style="font-weight: 400">Đây không chỉ là một nền tảng đọc truyện tranh trực tuyến phổ biến,
                ...
                là một bài giới thiệu {{ $siteName }} hi họng đã giúp bạn hiểu rõ hơn về
