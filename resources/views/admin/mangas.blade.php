        ...
        <div class="card">
            <div class="card-header">
                <ul class="nav nav-tabs card-header-tabs" role="tablist">
                    ...
                    <li class="nav-item" role="presentation">
                        <button class="nav-link" data-bs-toggle="tab" data-bs-target="#trending" type="button" role="tab">
                            Top thịnh hành
                        </button>
                    </li>
                </ul>
                        ...
                        <form id="crawl-form">
                            ...
                            <div class="row mb-3">
                                <div class="col-md-12">
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" id="custom-pages" name="custom_pages">
                            ...
                            <div class="row mb-3" id="pages-config" style="display: none;">
                                <div class="col-md-4">
                                    ...
                                    <input type="text" class="form-control" id="pages-input" name="pages" placeholder="1" disabled>
                                </div>
                            ...
                            <div class="row mb-3">
                                <div class="col-md-12">
                                    ...
                                    <button type="button" class="btn btn-secondary" id="stop-crawl-btn" style="display: none;">
                        ...
                        <form id="trending-form">
                            <div class="row mb-3">
                                <div class="col-md-12">
                                    ...
                                    <input type="text" class="form-control" id="trending-search" placeholder="Nhập tên hoặc slug truyện...">
                                </div>
                            </div>
                            <div class="row mb-3">
                                <div class="col-md-12">
                                    <div id="trending-search-results" style="max-height: 300px; overflow-y: auto; border: 1px solid #ddd; padding: 10px; display: none; background: #f8f9fa;">
                                    </div>
                                </div>
                            </div>
                            <div class="row mb-3">
    ...
    $(document).ready(function() {
        ...
        $(document).on('click', '.select-trending-manga', function() {
            if (selectedMangas.length >= 8) {
                alert('Chỉ được chọn tối đa 8 truyện');
                return;
            }
        ...
        $('#trending-form').on('submit', function(e) {
            ...
            if (selectedMangas.length === 0) {
                alert('Vui lòng chọn ít nhất 1 truyện');
                return;
            }
            ...
            $.ajax({
                ...
                success: function(response) {
                    if (response.status === 'success') {
                        alert('Đã lưu danh sách Top thịnh hành thành công');
                    } else {
                        alert('Có lỗi xảy ra');
                    }
                },
