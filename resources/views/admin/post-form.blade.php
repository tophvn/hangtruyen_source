                ...
                <form id="post-form">
                    ...
                    <div class="row mb-3">
                        <div class="col-md-12">
                            ...
                            @if($post && $post->image)
                                <img src="{{ $post->image }}" alt="Preview" class="img-thumbnail mt-2" style="max-width: 300px;">
                            @endif
                        </div>
                    </div>
                    ...
                    <div class="row mb-3">
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control" id="author" name="author" value="{{ $post->author ?? auth()->user()->name }}">
                        </div>
                        <div class="col-md-6">
                    ...
                    <div class="row mb-3">
                        <div class="col-md-12">
                            ...
                            <textarea id="content" name="content" class="form-control" rows="15" style="min-height: 400px;">{{ $post->content ?? '' }}</textarea>
                        </div>
                    </div>
