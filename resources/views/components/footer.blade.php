        ...
        <div class="row">
            ...
            <div class="col-12 col-lg-6">
                <ul class="f-menu">
                    ...
                    <li><a href="/trang/phuong-thuc-lien-he" rel="nofollow">Phương thức liên hệ</a></li>
            ...
            <div class="col-12 col-lg-2">
                <ul class="social-link">
                    <li>
                        <a href="https://www.facebook.com/hangtruyen.net/" aria-label="Facebook" rel="nofollow">
                    ...
                    <li>
                        <a href="https://x.com/hangtruyennet" aria-label="Twitter" rel="nofollow">
                            <svg xmlns="http://www.w3.org/2000/svg" width="34" height="34" viewBox="0 0 34 34" fill="none">
